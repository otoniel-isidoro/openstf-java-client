...
public class Device {
    ...
    /**
     * @param airplaneMode The airplaneMode
     */
    ...
    /**
     * @param presenceChangedAt The presenceChangedAt
     */
    ...
    /**
     * @param remoteConnect The remoteConnect
     */
    ...
    /**
     * @param remoteConnectUrl The remoteConnectUrl
     */
    ...
    /**
     * @param reverseForwards The reverseForwards
     */
    ...
    /**
     * @param statusChangedAt The statusChangedAt
     */
    ...
    public String toString() {
        return "Device{" + "abi='" + abi + '\'' + ", airplaneMode=" + airplaneMode + ", battery=" + battery +
                ", browser=" + browser + ", channel='" + channel + '\'' + ", createdAt='" + createdAt +
                '\'' + ", display=" + display + ", manufacturer='" + manufacturer + '\'' +
                ", model='" + model + '\'' + ", network=" + network + ", operator='" + operator + '\'' +
                ", owner=" + owner + ", phone=" + phone + ", platform='" + platform + '\'' + ", presenceChangedAt='" +
                presenceChangedAt + '\'' + ", present=" + present + ", product='" + product + '\'' + ", provider=" +
                provider + ", ready=" + ready + ", remoteConnect=" + remoteConnect + ", remoteConnectUrl=" +
                remoteConnectUrl + ", reverseForwards=" + reverseForwards + ", sdk='" + sdk + '\'' + ", serial='" +
                serial + '\'' + ", status=" + status + ", statusChangedAt='" + statusChangedAt + '\'' + ", version='" +
                version + '\'' + ", using=\'" + using +  "\', usage=\'" + usage +  "\', notes=\'"+  notes + "\'}";
    }
}
